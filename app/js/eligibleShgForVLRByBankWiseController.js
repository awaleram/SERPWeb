...
(function () {
    ...
    app.controller('eligibleShgForVLRByBankWiseController', ['Base64', '$scope', '$http', function(Base64, $scope, $http) {
        ...
        $scope.submit= function(){
            ...
            $http.get('https://localhost:8443/mifosng-provider/api/v1/runreports/Eligible%20Shg%20for%20Vlr%20bank%20and%20Brach%20wise?tenantIdentifier=default&R_startDate=' + startDate + '&R_endDate=' + endDate + '&locale=en&R_bank_name=' + $scope.bank_name + '&R_ifsc_code=' + $scope.ifsc_code).success(function (data) {
