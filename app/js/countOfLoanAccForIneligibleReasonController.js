...
(function () {
    ...
    app.controller('countOfLoanAccForIneligibleReasonController', ['Base64', '$scope', '$http', function(Base64, $scope, $http) {
        ...
        $scope.submit= function(){
            ...
            $http.get('https://localhost:8443/mifosng-provider/api/v1/runreports/Count%20of%20Loan%20accounts%20against%20%E2%80%9CIneligibility%20Reasons%E2%80%9D%20Bank%20and%20Branch%20wise?tenantIdentifier=default&R_startDate=' + startDate + '&R_endDate=' + endDate + '&locale=en&R_bank_name=' + $scope.bank_name + '&R_ifsc_code=' + $scope.ifsc_code).success(function (data) {
