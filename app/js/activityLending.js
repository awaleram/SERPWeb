...
(function () {
    ...
    app.controller('activityBasedLendingCountCtrl', ['Base64', '$scope', '$http', function(Base64, $scope, $http) {
        ...
        $scope.submit = function() {
            ...
            $http.get('https://localhost:8443/mifosng-provider/api/v1/runreports/ActivityBaseLendingCount?tenantIdentifier=default&R_startDate=' + startDate + '&R_endDate=' + endDate + '&locale=en&R_districts=' + $scope.districtCode + '&R_mandals=' + $scope.mandalCode + '&R_states=-1&R_vos=' + $scope.voCode + '&R_Shgs=' + $scope.shgCode + '&R_SocialCategory=' + $scope.socialCategoryCode + '&R_panchayats=' + $scope.panchayatCode + '&R_areaCluster=' + $scope.areaClusterCode + '&R_communityCluster=' + $scope.communityClusterCode).success(function (data) {
                ...
                options = {
                    ...
                    title: {
                        text: 'Count of Activity Based Lending Members (%) - MBK'
                    },
                    xAxis: {
        ...
        .controller('activityBasedLendingAmountCtrl', ['Base64', '$scope', '$http', function(Base64, $scope, $http) {
        ...
        .controller('unutilizedCCLCtrl', ['Base64', '$scope', '$http', function(Base64, $scope, $http) {
        ...
        .controller('ratioofIGAtoConsumptionCtrl', ['Base64', '$scope', '$http', function(Base64, $scope, $http) {
