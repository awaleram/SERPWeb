...
(
   function(){
       ...
       var app= angular.module('myApp.controller');
        ...
        app.controller('eligibleLoanAccForVlrByDistMandalWiseController', ['Base64', '$scope', '$http', function(Base64, $scope, $http) {
