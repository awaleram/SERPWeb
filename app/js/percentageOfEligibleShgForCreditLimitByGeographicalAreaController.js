...
(
    function(){
        ...
        app.controller('percentageOfEligibleShgForCreditLimitByGeographicalAreaController', ['Base64', '$scope', '$http', function(Base64, $scope, $http) {
            ...
            $scope.submit = function(){
                ...
                $http.get('https://localhost:8443/mifosng-provider/api/v1/runreports/Percentage%20of%20Eligible%20SHG%20for%20Credit%20Limit%20Geographical%20area%20wise?tenantIdentifier=default&R_startDate=' + startDate + '&R_endDate=' + endDate + '&locale=en&R_districts=' + $scope.districtCode + '&R_mandals=' + $scope.mandalCode + '&R_states=-1&R_vos=' + $scope.voCode + '&R_Shgs=' + $scope.shgCode + '&R_SocialCategory=' + $scope.socialCategoryCode + '&R_panchayats=' + $scope.panchayatCode + '&R_areaCluster=' + $scope.areaClusterCode + '&R_communityCluster=' + $scope.communityClusterCode ).success(function(data){
                    ...
                    options = {
                        ...
                        title: {
                            text: '% Of Eligible SHG for Achieved Credit Limit'
                        },
                        xAxis: {
                        ...
                        series: [{
                            name: '% Of Eligible SHG for Achieved Credit Limit',
