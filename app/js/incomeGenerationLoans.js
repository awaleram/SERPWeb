...
(function () {
    ...
    app.controller('loansforIncomeGenerationPurposeCtrl', ['Base64', '$scope', '$http', function(Base64, $scope, $http) {
        ...
        .controller('loanAmountIGACtrl', ['Base64', '$scope', '$http', function(Base64, $scope, $http) {
        ...
        .controller('loanAmountPercentageforIncomeGenerationPurposeCtrl', ['Base64', '$scope', '$http', function(Base64, $scope, $http) {
